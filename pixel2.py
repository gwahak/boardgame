...
if i>=64:
    ...
    check3 = count2(3)
    check4 = count2(4)
    print(playername(1),"2목을", check1, "개 만들었습니다.")
    print(playername(2),"2목을", check2, "개 만들었습니다.")
    print(playername(3),"2목을", check3, "개 만들었습니다.")
    print(playername(4),"2목을", check4, "개 만들었습니다.")
